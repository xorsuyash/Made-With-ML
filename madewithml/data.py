...
def load_data(dataset_loc:str ,num_samples:int=None)->Dataset:
    ...
    Args:
        dataset_loc (str): Loacation of the datset 
        num_samples (int,optional) : The number of samples to load . Defau;t to None 


    Returns:
        Dataset: Our datset represented by as Ray Datset

    """

    ds=ray.data.read_csv(dataset_loc)
    ds.random_shuffle(seed=1234)
